...
class RenderItem extends Component {
  ...
  render() {
    ...
    return (
      <div className="item_nhaleganday_detailnhale">
        <div className="item_img_nhaleganday_detailnhale">
          <Link
            to={{
          ...
          >
            <img src={item.Avatar} className="img_nhaleganday_detailnhale" />
          </Link>
          <div
            className={
              isQuanTam
                ? "icon_qt_nhaleganday_detailnhale_hover"
                : "icon_qt_nhaleganday_detailnhale"
            }
        ...
        <div className="item_thongtin_nhaleganday_detailnhale">
          <Link
            to={{
              pathname: `/mua-nha/${tiengVietKhongDau(item.TenCH).replace(
                / |,/g,
          ...
          >
            <h2 className="title_item_thongtin_nhaleganday_detailnhale">
              {item.TenCH}
            </h2>
          </Link>
          <p className="diachi_item_thongtin_nhaleganday_detailnhale">
            <i className="fa fa-map-marker" />
            {item.DiaChi}
          </p>
          <p className="gia_item_thongtin_nhaleganday_detailnhale">
            Giá niêm yết: {item.Gia}
          </p>
          <div className="sl_item_thongtin_nhaleganday_detailnhale">
            <div>
