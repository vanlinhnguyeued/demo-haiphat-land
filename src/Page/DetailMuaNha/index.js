...
class index extends Component {
  ...
  render() {
    ...
    return (
      <div className="detailnhale">
        <Banner data={dataImg} showModal={(e) => this.modal.showModal(e)} />
        <div className="container_detailnhale">
          <h4>{data.TieuDe}</h4>
          <p className="diachi_detailnhale">
            <i className="fa fa-map-marker" /> {data.DiaChi}
          </p>
          <p className="gia_detailnhale">
            {data.Gia}
            <span>{data.TrangThai}</span>
          </p>
          <div className="content_detailnhale">
            <div className="thongtin_detailnhale">
              <h4>Thông tin chính</h4>
              <div className="row_tinchinh_detailnhale">
                <div className="col1_tinchinh_detailnhale">
                  {arrayTTC
                    .filter((e) => e.ID <= 5)
                    .map((item, index) => (
                      <div className="item_tinchinh_detailnhale" key={index}>
                        <div className="title_item_tinchinh_detailnhale">
                          {item.TieuDe}
                        </div>
                        <div
                          style={{
                ...
                <div className="col2_tinchinh_detailnhale">
                  {arrayTTC
                    .filter((e) => e.ID > 5)
                    .map((item, index) => (
                      <div className="item_tinchinh_detailnhale" key={index}>
              ...
              <div className="row_tienich_detailnhale">
                {data.TienIch.map((item, index) => (
                  <div className="item_tienich_detailnhale" key={index}>
              ...
              <div className="row_bando_detailnhale">
                <div className="col1_bando_detailnhale">
                  <BieuDo
                    lat={data.Lat}
                    lng={data.Lng}
                    TieuDe={data.DiaChi}
                ...
                <div className="col2_bando_detailnhale">
                  {data.DiaDiemLC.map((item, index) => (
                    <div className="item_diadialc_detailnhale" key={index}>
            ...
            <div className="lienhe_detailnhale">
