...
class index extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className="daily_lienhe_detailthuenha">
          <h2>Liên hệ người bán</h2>
          <div className="row_daily_lienhe_detailthuenha">
            <Link
              to={{
            ...
            >
              <img
                src={ceo.Avatar}
                className="img_daily_lienhe_detailthuenha"
              />
            </Link>
            <div className="thongtin_daily_lienhe_detailthuenha">
              <Link
                to={{
                  pathname: `/can-nhan/${tiengVietKhongDau(ceo.Ten).replace(
                    / /g,
              ...
              >
                <h2 className="name_daily_lienhe_detailthuenha" title={ceo.Ten}>
                  {ceo.Ten}
                </h2>
              </Link>
        ...
        <div className="box_lienhe_detailthuenha">
          ...
          <div
            ...
            className="button_lienhe_detailthuenha"
          >
            Gửi liên hệ
          </div>
        </div>
        <div className="box_baocao_detailthuenha">
          <h2>Báo cáo lỗi</h2>
          <p>
          ...
          <div
            ...
            className="button_baocao_detailthuenha"
          >
            Gửi báo cáo
          </div>
        </div>
