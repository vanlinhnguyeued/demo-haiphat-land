...
function HouseForRent({}) {
  ...
  if (listHouseForSale.length == 0)
    ...
    return (
      <div>
        <div>
          <a className="title_duan_home" href="/thue-nha">
            {listHouseForSale.length} Nhà lẽ thuê
          </a>
        </div>
...
HouseForRent.propTypes = PropsType;
const mapStateToProps = (state) => ({});

const mapDispatchToProps = (dispatch) => {
  return bindActionCreators({}, dispatch);
};
export default connect(mapStateToProps, mapDispatchToProps)(HouseForRent);
