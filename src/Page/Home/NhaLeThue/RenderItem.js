...
class RenderItem extends Component {
  ...
  render() {
    ...
    return (
      <div
        className="item_nhathue_home"
        data-aos={index <= 3 ? "fade-left" : "fade-right"}
      >
        <div className="item_img_nhathue_home">
          <Link
            to={{
          ...
          >
            <img src={item.Avatar} className="img_nhathue_home" />
          </Link>
          <div
            className={
              isQuanTam ? "icon_qt_nhathue_home_hover" : "icon_qt_nhathue_home"
            }
        ...
        <div className="item_thongtin_nhathue_home">
          <Link
            to={{
              pathname: `/mua-nha/${tiengVietKhongDau(item.TenCH).replace(
                / |,/g,
          ...
          >
            <h2 className="title_item_thongtin_nhathue">{item.TenCH}</h2>
          </Link>
          <p className="diachi_item_thongtin_nhathue">
            <i className="fa fa-map-marker" />
            {item.DiaChi}
          </p>
          <p className="gia_item_thongtin_nhathue">Giá niêm yết: {item.Gia}</p>
          <div className="sl_item_thongtin_nhathue">
            <div>
