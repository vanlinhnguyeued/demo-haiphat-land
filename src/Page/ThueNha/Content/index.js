...
class index extends React.Component {
  ...
  render() {
    ...
    const sapXep = [
      { name: "Ngẫu nhiên", code: 1 },
      { name: "Độ ưu tiên giảm dần", code: 2 },
      { name: "Độ ưu tiên tăng dần", code: 3 },
      { name: "Mới nhất", code: 4 },
      { name: "Cũ nhất", code: 5 },
      { name: "A-Z", code: 6 },
      { name: "Z-A", code: 7 },
      { name: "Giá giảm dần", code: 8 },
      { name: "Giá tăng dần", code: 9 },
    ];
      ...
      <div className="div-rowtt">
        <div className={isMap ? "thuenha_col" : "thuenha_list"}>
          ...
          <div className="div-thongtin">
            ...
            <div className="div_pagination_thuenha">
              <Pagination
                defaultCurrent={1}
                total={30}
