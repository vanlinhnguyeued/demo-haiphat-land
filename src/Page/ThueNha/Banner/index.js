    ...
    return (
      <div className="SearchBar">
        ...
        <Dropdown
          ...
          overlay={
            <div className="content_drop_nhalethue" id="scroll_filter">
              <div className="label_drop_nhalethue">
                <p>Khu vực</p>
                <CheckOutlined />
              </div>
        ...
        <Dropdown
          ...
          overlay={
            <div className="content_drop_nhalethue" id="scroll_filter">
              <div className="label_khoanggia_drop_nhalethue">
                <div
                  style={{
                    marginRight: 15,
                    display: "flex",
